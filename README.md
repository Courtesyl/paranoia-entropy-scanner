...
Options
-t, --threshold — Entropy threshold (0–8). For AES/RSA keys use 7.2+ (default: 6.0)
-c, --chunk — Window size in bytes (default: 256)
-s, --step — Step size in bytes (default: 64)
⚠️ Small steps (e.g., 1) drastically increase CPU time
